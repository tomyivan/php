...
/* $Titulos = ['Id','Fecha','Presentador','Edicion','Emitido','Productor','Descripcion','Formato','Ciudad','Periodista',
  'Editor','Contenido','Duracion','Bloque','mm_ss','Hora Programada'];
  $Datos=[$Titulos];
  $xlsx = Shuchkin\SimpleXLSXGen::fromArray($Datos);
  $xlsx->saveAs('Escaleta'.date('Y-m-d')); */
?>
